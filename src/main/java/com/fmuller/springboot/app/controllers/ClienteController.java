...
import com.fmuller.springboot.app.util.paginator.PageRender;
...
//	@RequestMapping(value="listar",method=RequestMethod.GET)
	...
	@ResponseBody
	public List<Cliente> listarRestJson() {
		return clienteService.findAll();
	}
	
	@GetMapping({"/listar-rest-xml","/"})
	@ResponseBody
	public ClienteList listarRestXmlJson() {
		return new ClienteList(clienteService.findAll());
	}

//	@RequestMapping(value="listar",method=RequestMethod.GET)
	@GetMapping({"/listar"})
	public String listar(@RequestParam(name = "page", defaultValue = "0") int page, Model model, Authentication authenticacion, HttpServletRequest request,
			Locale locale) {
		...
		if(auth !=  null) {
//			logger.info("Utilizando  forma estatica SecurityContextHolder.getContext().getAuthentication() : usuario autenticado, tu username es: ".concat(authenticacion.getName()));
		}
